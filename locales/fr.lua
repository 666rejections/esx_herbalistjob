...
Locales['fr'] = {
	...
	['herbalist_clothes_wor'] = 'Tenue de travail',
	['veh_menu'] = 'Garage',
	...
	['plant_taken'] = 'Vous être en train de ramasser des plantes',
	['press_traitement'] = 'appuyez sur ~INPUT_CONTEXT~ pour transformer vos plantes',
	['press_collect'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter des plantes',
	...
	['not_enough_plant'] = 'Vous n\'avez plus de plantes',
